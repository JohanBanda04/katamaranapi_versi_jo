...
class MyModel extends CI_Model {
    ...
    /*ini dia kuncinya menandakan api dipanggil*/
    ...
    public function agendaByRangeTanggal_ori($tanggalAwal, $tanggalAkhir){
    ...
    public function agendaByRangeTanggal($tanggalAwal, $tanggalAkhir){
        return $this->db->query("SELECT * FROM `agenda` WHERE DATE(tanggal) BETWEEN '$tanggalAwal' AND '$tanggalAkhir'")->result();
    }
